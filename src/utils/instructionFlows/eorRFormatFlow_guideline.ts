...
/**
 * R-Format EOR Instruction Flow: EOR X1, X2, X3
 * Following the EXACT workflow specification from the guideline (same as ADD/SUB/AND/ORR except for ALU operation)
 */
...
const executeStage: StageDataFlow = {
  ...
  operations: [
    ...
    {
      type: 'merge',
      sourceCircleIds: ['C_ALUSrc=0', 'D_Rm_Val=0xFF00'],
      targetComponent: 'MuxReadRegData',
      timing: 800,
      resultData: 'D_Rm_Val=0xFF00',
    ...
    // 6. ALU Operation (EOR: 0xFFFF ^ 0xFF00 = 0x00FF)
    {
      type: 'merge',
      sourceCircleIds: ['D_Rn_Val=0xFFFF', 'D_Rm_Val=0xFF00'],
...
// Complete EOR instruction flow
export const EOR_R_FORMAT_FLOW: StageDataFlow[] = [
  UNIVERSAL_IF_STAGE,
  UNIVERSAL_ID_STAGE,
  executeStage,
  memoryStage,
