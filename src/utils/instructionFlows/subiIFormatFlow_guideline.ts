...
/**
 * I-Format SUBI Instruction Flow: SUBI X1, X2, #8
...
const executeStage: StageDataFlow = {
  ...
  operations: [
    ...
    {
      type: 'merge',
      sourceCircleIds: ['C_ALUSrc=1', 'D_SignExt_Imm=8'],
      targetComponent: 'MuxReadRegData',
      timing: 700,
      resultData: 'D_SignExt_Imm=8',
    ...
    // 5. ALU Operation (SUBI: 100 - 8 = 92)
    {
      type: 'merge',
      sourceCircleIds: ['D_Rn_Val=100', 'D_SignExt_Imm=8'],
      targetComponent: 'ALUMain',
      timing: 800,
      resultData: 'D_ALU_Result=92'
    }
  ],
  finalCircles: ['D_ALU_Result=92', 'D_Write_Addr_Idx', 'C_RegWrite=1', 'C_MemRead=0', 'C_MemWrite=0', 'C_MemToReg=0', 'C_UncondBranch=0', 'C_ZeroBranch=0'],
...
const memoryStage: StageDataFlow = {
  ...
  duration: 1500,
  initialCircles: ['D_ALU_Result=92', 'C_MemRead=0', 'C_MemWrite=0'],
  operations: [
    // Signal Propagation (Bypass) - ALU result travels to two destinations
    {
      type: 'split',
      sourceCircleIds: ['D_ALU_Result=92'],
      targetComponent: 'ALUMain',
      timing: 0,
      splitResults: [
        {
          newValue: 'D_ALU_Result=92',
          newType: 'data_signal',
          targetComponent: 'DataMem',
  ...
  finalCircles: ['D_ALU_Result=92', 'C_MemToReg=0', 'C_RegWrite=1'],
...
const writeBackStage: StageDataFlow = {
  ...
  duration: 1500,
  initialCircles: ['D_ALU_Result=92', 'D_Write_Addr_Idx', 'C_MemToReg=0', 'C_RegWrite=1'],
  operations: [
    // Multiplexer Selection
    {
      type: 'merge',
      sourceCircleIds: ['C_MemToReg=0', 'D_ALU_Result=92'],
      targetComponent: 'MuxReadMemData',
      timing: 0,
      resultData: 'D_ALU_Result=92',
    ...
    {
      type: 'merge',
      sourceCircleIds: ['C_RegWrite=1', 'D_ALU_Result=92', 'D_Write_Addr_Idx'],
      targetComponent: 'RegFile',
      timing: 500,
...
// Complete SUBI instruction flow
export const SUBI_I_FORMAT_FLOW: StageDataFlow[] = [
  UNIVERSAL_IF_STAGE,
  UNIVERSAL_ID_STAGE,
  executeStage,
  memoryStage,
