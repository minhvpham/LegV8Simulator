...
/**
 * I-Format ORRI Instruction Flow: ORRI X1, X2, #0xFF
...
const executeStage: StageDataFlow = {
  ...
  operations: [
    ...
    // 3. Sign extend immediate
    {
      ...
      timing: 600,
      resultData: 'D_SignExt_Imm=0x00FF',
    ...
    {
      type: 'merge',
      sourceCircleIds: ['C_ALUSrc=1', 'D_SignExt_Imm=0x00FF'],
      targetComponent: 'MuxReadRegData',
      timing: 700,
      resultData: 'D_SignExt_Imm=0x00FF',
    ...
    // 5. ALU Operation (ORRI: 0xFF00 | 0x00FF = 0xFFFF)
    {
      type: 'merge',
      sourceCircleIds: ['D_Rn_Val=0xFF00', 'D_SignExt_Imm=0x00FF'],
...
// Complete ORRI instruction flow
export const ORRI_I_FORMAT_FLOW: StageDataFlow[] = [
  UNIVERSAL_IF_STAGE,
  UNIVERSAL_ID_STAGE,
  executeStage,
  memoryStage,
